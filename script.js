...
function drawText() {
    ...
    // glow effect
    context.shadowColor = "rgba(220, 20, 60, 0.7)";
    context.shadowBlur = 8;
    context.shadowOffsetX = 0;
    context.shadowOffsetY = 0;

    if(frameNumber < 250){
        context.fillStyle = `rgba(220, 20, 60, 0.7, ${opacity})`;
    ...
    if(frameNumber > 2500 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["I love you so much Khadidja <3, more than", "all the time and space in the universe can contain"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        } else {
            context.fillText("I love you so much Khadidja <3, more than all the time and space in the universe can contain", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber >= 2750 && frameNumber < 99999){
        context.fillStyle = `rgba(220, 20, 60, 0.7, ${secondOpacity})`;
    ...
    if(frameNumber >= 3000 && frameNumber < 99999){
        context.fillStyle = `rgba(220, 20, 60, 0.7, ${thirdOpacity})`;
